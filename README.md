# Recipe Book API
This is a backend API for a personalized recipe book web application, developed using Node.js, Express.js, Firebase Cloud Firestore, and Cloud Storage. I've defined endpoints supporting the following features for users:
